...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract IEVMVaultFactory",
        name: "",
        type: "address",
      },
    ],
...
export class EVMVault__factory {
  static readonly abi = _abi;
  static createInterface(): EVMVaultInterface {
    return new utils.Interface(_abi) as EVMVaultInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): EVMVault {
    return new Contract(address, _abi, signerOrProvider) as EVMVault;
  }
}
